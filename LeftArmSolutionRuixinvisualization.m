%This function is used to test and visualize the result for inverse
%kinematics of Nao's arms
clear; clc; close all;
...
for i = 0:0.1:2*pi
    ...
    Ti2 = T1\Ti1;
%if(l1*Ti2(1,4) + l2 * Ti2(3,4) >= 0)
 %   theta2 = acos((l2*Ti2(1,4)-l1*Ti2(3,4))/(l1^2+l2^2));
%end
%if(l1*Ti2(1,4) + l2 * Ti2(3,4) < 0)
%    theta2 = -acos((l2*Ti2(1,4)-l1*Ti2(3,4))/(l1^2+l2^2));
%end
%theta2 = [acos((l2*Ti2(1,4)-l1*Ti2(3,4))/(l1^2+l2^2)) -acos((l2*Ti2(1,4)-l1*Ti2(3,4))/(l1^2+l2^2))];
%theta2 = atan2(l1*Ti2(1,4)+l2*Ti2(3,4),l2*Ti2(1,4)-l1*Ti2(3,4));
